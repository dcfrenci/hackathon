...
- [Architecture](#architecture)
  - [Hand Gesture Model](#hand-gesture-model-mediapipe)
  - [Depth Model](#depth-model)
- [Chain Loop (Flow)](#chain-loop-flow-of-the-model)
- [Setup](#setup)
...
> [!IMPORTANT]
> ### 🏆 Achievement
> Obtained an **honorable mention** from the jury, ranking 4th out of 12 teams at **Google Developer Group's Hackathon** 2026.
